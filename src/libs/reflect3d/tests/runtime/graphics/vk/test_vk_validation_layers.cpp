...
TEST_CASE("Verify validation layer support") {
  ...
  std::vector<rf3d::vk::detail::core::LayerProperties> const supported_layers = {
    {
      ...
      .specVersion           = rf3d::vk::detail::core::ApiVersion10,
  ...
  CHECK(rf3d::vk::detail::check_validation_layer_support(supported_layers, required_layers));
}
...
TEST_CASE("Verify validation layer support - missing layer") {
  ...
  CHECK_FALSE(rf3d::vk::detail::check_validation_layer_support(supported_layers, required_layers));
}
