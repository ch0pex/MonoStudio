...
inline constexpr Vertex vertex1 {.position = {0.0F, -0.5F}, .color = {1.0F, 0.0F, 0.0F}};
inline constexpr Vertex vertex2 {.position = {0.5F, 0.5F}, .color = {0.0F, 1.0F, 0.0F}};
inline constexpr Vertex vertex3 {.position = {-0.5F, 0.5F}, .color = {0.0F, 0.0F, 1.0F}};
inline constexpr std::array vertices                  = {vertex1, vertex2, vertex3};
inline constexpr std::array<std::uint16_t, 3> indices = {0, 2, 3};
