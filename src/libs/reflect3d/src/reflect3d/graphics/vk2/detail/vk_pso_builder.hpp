...
#include "reflect3d/graphics/vk2/detail/utils/vk_defaults.hpp"
#include "reflect3d/graphics/vk2/detail/utils/vk_native_types.hpp"
#include "reflect3d/graphics/vk2/detail/vk_gpu_detail.hpp"
#include "reflect3d/graphics/vk2/detail/vk_pso.hpp"
#include "reflect3d/graphics/vk2/detail/vk_shader.hpp"

namespace rf3d::vk::detail {

inline std::string const vertex_entry_point_name   = "main"; // NOLINT
inline std::string const fragment_entry_point_name = "main"; // NOLINT
...
public:
  ...
  Pipeline build() {
    ...
    raii::PipelineLayout pipeline_layout = make_pipeline_layout(layout_info);
    ...
    Pipeline pipeline {
      ...
      make_graphics_pipeline(pipeline_info_chain.get<pipeline_info_type>()) //
    };
...
private:
  ...
  vertex_input_info_type vertex_input_info;
