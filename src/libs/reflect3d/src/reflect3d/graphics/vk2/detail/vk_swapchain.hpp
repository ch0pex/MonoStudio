...
#include "reflect3d/graphics/vk2/detail/vk_gpu.hpp"
#include "reflect3d/graphics/vk2/detail/vk_image.hpp"
#include "reflect3d/graphics/vk2/detail/vk_swapchain_detail.hpp"
...
struct Semaphores {
  raii::Semaphore present {make_semaphore()};
  raii::Semaphore render {make_semaphore()};
};
